...
async function runRegression() {
  console.log('=== Stage 12 Regression Verification (Stages 1–11) ===\n');
  ...
  console.log(`   ✓ Stage 7 passed (Mapped to UniProt ${protCtx.protein.accession}).`);

  // Stage 8: Structural Context
  console.log('7. Checking Stage 8 (Variant Structural Context)...');
  const structCtx = await getStructuralContextForVariant(protCtx);
  ...
  console.log('\n=====================================================');
  console.log('REGRESSION SUITE PASSED (STAGES 1–11 INTACT)');
  console.log('=====================================================');
}
